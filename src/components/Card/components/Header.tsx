...
export default function Header(props: IProps) {
    return (
        <header>
            <div className="logo" data-bay-click="this.setProject('welcome')" data-2ef067c7="">
                <img src="imgs/isometric-j-icon.png" alt="Jhonatan Costa logo" />
            </div>
            <div>
                <ul>
                    <li className="email"> <a aria-label="email" href={`mailto:${props.email}`}><svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="857.333" height="620" viewBox="0 0 643 465">
